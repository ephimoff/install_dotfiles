...
class Messages {
    ...
    static showUpdateMessage(version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield Messages.showMessage('info', `GitLens has been updated to v${version}`, SuppressedKeys.UpdateNotice, undefined, viewReleaseNotes);
    ...
    static showWelcomeMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield Messages.showMessage('info', `Thank you for choosing GitLens! GitLens is powerful, feature rich, and highly configurable, so please be sure to view the docs and tailor it to suit your needs.`, SuppressedKeys.WelcomeNotice, null, viewDocs);
            if (result === viewDocs) {

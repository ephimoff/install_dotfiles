                ...
                for (const line of chunk.lines) {
                    ...
                    if (cfg.hover.details) {
                        this._decorations.push({
                            hoverMessage: annotations_1.Annotations.getHoverMessage(commit, dateFormat, yield this.git.hasRemotes(commit.repoPath), this._config.blame.file.annotationType),
                            range: range
                        });
                    }

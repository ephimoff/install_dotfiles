...
class Repository extends vscode_1.Disposable {
    constructor(folder, path, git, onAnyRepositoryChanged, suspended) {
        super(() => this.dispose());
        this.folder = folder;
        this.path = path;
        this.git = git;
    ...
    onConfigurationChanged(e) {
        ...
        if (initializing || configuration_1.configuration.changed(e, section, this.folder.uri)) {
            this._providerMap = factory_1.RemoteProviderFactory.createMap(configuration_1.configuration.get(section, this.folder.uri));
            if (!initializing) {
    ...
    getRemotes() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._remotes === undefined) {
                this._remotes = yield this.git.getRemotesCore(this.path, this._providerMap);
            }

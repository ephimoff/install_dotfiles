...
class GitExplorer {
    ...
    onGitChanged(e) {
        if (this._root === undefined || this._view !== GitExplorerView.Repository || e.reason !== gitService_1.GitChangeReason.Repositories)
            return;
        this.clearRoot();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (this._view) {
                case GitExplorerView.History: {
                    ...
                    this._loading = promise.then((_) => __awaiter(this, void 0, void 0, function* () { return yield system_1.Functions.wait(0); }));
                    return promise;
                }
                default: {

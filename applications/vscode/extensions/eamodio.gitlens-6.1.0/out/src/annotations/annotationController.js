...
class AnnotationController extends vscode_1.Disposable {
    ...
    onConfigurationChanged(e) {
        ...
        if (initializing ||
            ...
            configuration_1.configuration.changed(e, configuration_1.configuration.name('theme')('lineHighlight').value)) {
            exports.Decorations.blameHighlight && exports.Decorations.blameHighlight.dispose();
            if (cfg === undefined) {
                ...
                exports.Decorations.blameHighlight = vscode_1.window.createTextEditorDecorationType({
                    ...
                    dark: {
                        backgroundColor: cfgHighlight.locations.includes(configuration_1.LineHighlightLocations.Line)
                            ? cfgTheme.dark.backgroundColor || configuration_1.configuration.defaults.theme.lineHighlight.dark.backgroundColor
                            : undefined,
                        ...
                        overviewRulerColor: cfgHighlight.locations.includes(configuration_1.LineHighlightLocations.OverviewRuler)
                            ? cfgTheme.dark.overviewRulerColor || configuration_1.configuration.defaults.theme.lineHighlight.dark.overviewRulerColor
                            : undefined
                    },
                    light: {
                        backgroundColor: cfgHighlight.locations.includes(configuration_1.LineHighlightLocations.Line)
                            ? cfgTheme.light.backgroundColor || configuration_1.configuration.defaults.theme.lineHighlight.light.backgroundColor
                            : undefined,
                        gutterIconPath: cfgHighlight.locations.includes(configuration_1.LineHighlightLocations.Gutter)
                            ? this.context.asAbsolutePath('images/light/highlight-gutter.svg')
                            : undefined,
                        overviewRulerColor: cfgHighlight.locations.includes(configuration_1.LineHighlightLocations.OverviewRuler)
                            ? cfgTheme.light.overviewRulerColor || configuration_1.configuration.defaults.theme.lineHighlight.light.overviewRulerColor
                            : undefined
                    }
                });
            }
        ...
        if (configuration_1.configuration.changed(e, configuration_1.configuration.name('blame')('file').value) ||
            ...
            configuration_1.configuration.changed(e, configuration_1.configuration.name('theme')('annotations')('file').value)) {
            if (cfg === undefined) {
                cfg = configuration_1.configuration.get();
            }

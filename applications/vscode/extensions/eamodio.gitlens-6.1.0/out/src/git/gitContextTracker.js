...
class GitContextTracker extends vscode_1.Disposable {
    ...
    onConfigurationChanged(e) {
        ...
        if (enabled) {
            this._listenersDisposable = vscode_1.Disposable.from(vscode_1.window.onDidChangeActiveTextEditor(system_1.Functions.debounce(this.onActiveTextEditorChanged, 50), this), vscode_1.workspace.onDidChangeTextDocument(system_1.Functions.debounce(this.onTextDocumentChanged, 50), this), this.git.onDidBlameFail(this.onBlameFailed, this), this.git.onDidChange(this.onGitChanged, this));
    ...
    onTextDocumentChanged(e) {
        if (this._context.editor === undefined || !comparers_1.TextDocumentComparer.equals(this._context.editor.document, e.document))
            return;
        if (this._context.state.dirty === e.document.isDirty)
            return;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (force || this._context.editor !== editor) {
                ...
                if (editor !== undefined) {
                    ...
                    this._context.uri = yield gitService_1.GitUri.fromUri(uri, this.git);
    ...
    updateRemotes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._context.repo !== undefined) {
                hasRemotes = yield this._context.repo.hasRemotes();
                constants_1.setCommandContext(constants_1.CommandContext.ActiveHasRemotes, hasRemotes);
            }
            else {
                constants_1.setCommandContext(constants_1.CommandContext.ActiveHasRemotes, false);
            }
            if (!hasRemotes) {

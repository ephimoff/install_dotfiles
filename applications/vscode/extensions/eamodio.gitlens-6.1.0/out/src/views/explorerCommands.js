...
class ExplorerCommands extends vscode_1.Disposable {
    ...
    setFilesLayout(layout) {
        return __awaiter(this, void 0, void 0, function* () {
            return vscode_1.workspace.getConfiguration(constants_1.ExtensionKey).update(configuration_1.configuration.name('gitExplorer')('files')('layout').value, layout, true);
        });
    }

...
class CurrentLineController extends vscode_1.Disposable {
    ...
    onConfigurationChanged(e) {
        ...
        if (initializing ||
            ...
            configuration_1.configuration.changed(e, configuration_1.configuration.name('theme')('annotations')('line')('trailing').value)) {
            changed = true;
        }
    ...
    showAnnotations(editor, type, reason = 'user') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!state.enabled || state.annotationType !== type) {
                ...
                yield this.clearAnnotations(editor);
    ...
    updateTrailingAnnotation(commit, blameLine, editor, line) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decoration = annotations_1.Annotations.trailing(commit, cfg.format, cfg.dateFormat === null ? this._config.defaultDateFormat : cfg.dateFormat, this._config.theme);
    ...
    provideDetailsHover(document, position, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = annotations_1.Annotations.getHoverMessage(logCommit || commit, this._config.defaultDateFormat, yield this.git.hasRemotes(commit.repoPath), this._config.blame.file.annotationType);

...
exports.createConfigWithClassicFoldersIcons = (config) => {
    return Object.assign({}, config, { folder: "_folder", folderExpanded: "_folder_open", rootFolder: "_folder_root", rootFolderExpanded: "_folder_root_open", folderNames: {}, folderNamesExpanded: {} });
};
